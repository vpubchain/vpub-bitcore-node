...
**Note**: To install services [insight-api](https://github.com/vpubchain/vpub-insight-api) and [insight-ui](https://github.com/vpubchain/vpub-insight-ui) you'll need to clone the repositories locally.
