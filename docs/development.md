...
**Note**: To install services [insight-api](https://github.com/vpubchain/particl-insight-api) and [insight-ui](https://github.com/vpubchain/particl-insight-ui) you'll need to clone the repositories locally.
